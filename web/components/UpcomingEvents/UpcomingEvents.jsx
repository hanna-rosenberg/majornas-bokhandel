    ...
    <div className={styles.container}>
      ...
      <div className={styles.information}>
        <div className={styles.informationContainer}>
          ...
          <p>
            Om inte annat anges öppnas dörren 18:30 och så börjar det 19:00. Fika finns att köpa. <br></br>Föranmälan
            krävs, den mailar du tillsammans med ditt namn och mobilnummer till:
          </p>
